...
class TricoBeaches extends StatefulWidget {
  const TricoBeaches({Key? key}) : super(key: key);

  @override
  State<TricoBeaches> createState() => _TricoBeachesState();
}

class _TricoBeachesState extends State<TricoBeaches> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          
            title: const Text("Trico",
