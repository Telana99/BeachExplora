...
class MulathivBeaches extends StatefulWidget {
  const MulathivBeaches({Key? key}) : super(key: key);

  @override
  State<MulathivBeaches> createState() => _MulathivBeachesState();
}

class _MulathivBeachesState extends State<MulathivBeaches> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          
            title: const Text("Mulathiv",
