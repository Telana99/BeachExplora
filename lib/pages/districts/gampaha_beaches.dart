...
class GampahaBeaches extends StatefulWidget {
  const GampahaBeaches({Key? key}) : super(key: key);

  @override
  State<GampahaBeaches> createState() => _GampahaBeachesState();
}

class _GampahaBeachesState extends State<GampahaBeaches> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          
            title: const Text("Gampaha",
