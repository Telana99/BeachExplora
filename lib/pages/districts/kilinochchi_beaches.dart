...
class KilinochchiBeaches extends StatefulWidget {
  const KilinochchiBeaches({Key? key}) : super(key: key);

  @override
  State<KilinochchiBeaches> createState() => _KilinochchiBeachesState();
}

class _KilinochchiBeachesState extends State<KilinochchiBeaches> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          
            title: const Text("Kilinochchi",
