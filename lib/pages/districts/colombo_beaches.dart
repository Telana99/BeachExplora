...
class ColomboBeaches extends StatefulWidget {
  const ColomboBeaches({Key? key}) : super(key: key);

  @override
  State<ColomboBeaches> createState() => _ColomboBeachesState();
}

class _ColomboBeachesState extends State<ColomboBeaches> {
  @override
