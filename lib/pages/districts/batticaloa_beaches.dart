...
class BatticaloaBeaches extends StatefulWidget {
  const BatticaloaBeaches({Key? key}) : super(key: key);

  @override
  State<BatticaloaBeaches> createState() => _BatticaloaBeachesState();
}

class _BatticaloaBeachesState extends State<BatticaloaBeaches> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          
            title: const Text("Batticaloa",
