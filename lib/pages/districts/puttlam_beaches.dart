...
class PuttalamBeaches extends StatefulWidget {
  const PuttalamBeaches({Key? key}) : super(key: key);

  @override
  State<PuttalamBeaches> createState() => _PuttalamBeachesState();
}

class _PuttalamBeachesState extends State<PuttalamBeaches> {
  @override
