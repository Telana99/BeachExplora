...
class AmparaBeaches extends StatefulWidget {
  const AmparaBeaches({Key? key}) : super(key: key);

  @override
  State<AmparaBeaches> createState() => _AmparaBeachesState();
}

class _AmparaBeachesState extends State<AmparaBeaches> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          
            title: const Text("Ampara",
