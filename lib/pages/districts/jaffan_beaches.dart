...
class JaffnaBeaches extends StatefulWidget {
  const JaffnaBeaches({Key? key}) : super(key: key);

  @override
  State<JaffnaBeaches> createState() => _JaffnaBeachesState();
}

class _JaffnaBeachesState extends State<JaffnaBeaches> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          
            title: const Text("Jaffna",
