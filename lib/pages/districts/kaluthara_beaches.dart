...
class KalutharaBeaches extends StatefulWidget {
  const KalutharaBeaches({Key? key}) : super(key: key);

  @override
  State<KalutharaBeaches> createState() => _KalutharaBeachesState();
}

class _KalutharaBeachesState extends State<KalutharaBeaches> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          
            title: const Text("Kaluthara",
