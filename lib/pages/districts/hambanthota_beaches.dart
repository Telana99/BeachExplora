...
class HambanthotaBeaches extends StatefulWidget {
  const HambanthotaBeaches({Key? key}) : super(key: key);

  @override
  State<HambanthotaBeaches> createState() => _HambanthotaBeachesState();
}

class _HambanthotaBeachesState extends State<HambanthotaBeaches> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          
            title: const Text("Hambanthota",
